...
const TELEMETRY_DISABLE_ENV_VARS = [
	"BRAINSTORM_DISABLE_TELEMETRY",
	"SUPERPOWERS_DISABLE_TELEMETRY",
	"DISABLE_TELEMETRY",
	"CLAUDE_CODE_DISABLE_NONESSENTIAL_TRAFFIC",
];
const TELEMETRY_DISABLED = TELEMETRY_DISABLE_ENV_VARS.some((name) =>
...
function brandMarkup() {
	...
	// Neutral branding — no third-party logo fetch, no outbound telemetry.
	// (This skill was adapted from Superpowers; the primeradiant.com logo URL
	// and github.com/obra/superpowers link were removed during adaptation.)
	const text = "Brainstorming v" + version;
	return (
		'<div class="brand"><span class="brand-copy">' + text + "</span></div>"
	);
}
