 ...
 * pi-hermes-memory / pi-observational-memory background work on turn_end).
 *
 * Usage:
 ...
 * - Does NOT touch compaction (owned by pi-observational-memory) or search
...
export default function handoffExtension(pi: ExtensionAPI): void {
	pi.registerCommand("handoff", {
		...
		handler: async (args, ctx) => {
			...
			const content = buildHandoff(entries, explicit);
